            ...
            editDept() {
                ...
                if (this.dep.id) {
                    this.$refs['deptFrom'].validate(valid => {
                        if (valid) {
                            this.postRequest("/mgrsystem/basic/department/upadate", this.menus).then(resp => {
                                if (resp) {
                    ...
                    this.$refs['deptFrom'].validate(valid => {
                        if (valid) {
                            this.postRequest("/mgrsystem/basic/department/", this.menus).then(resp => {
                                if (resp) {
                                    this.dialogVisible = false;
                                    this.initMenus();
                                }
