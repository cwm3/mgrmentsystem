...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "cwm3.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "cwm3.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "cwm3.mail.routing.key";
}
